...
from board import common_20210529_fixed as common
            ...
            if p == "D":
                ...
                if i == 170 and j == 106:
                    if (
                        ...
                        if (
                            count == 3
                            or (count == 2 and self.board[90] != "h")
                            or (self.board[107] == "i" and self.board[139] in "rp")
                        ):
                            score += average[self.version][not self.turn][False] // 2
                        else:
                            score += average[self.version][not self.turn][False] // 4
                ...
                if (i == 164 and j == 52 and self.board[51] == "d") or (
                    ...
                    if self.che < self.che_opponent:
                        ...
                        if (
                            ...
                            pass
                        elif (i == 164 and (self.board[151] != "N" or self.board[135] != "p")) and (
                            i == 170 and (self.board[159] != "N" or self.board[143] != "p")
                        ):
                            score -= 30
        ...
        if check_bozi:
            ...
            if p == "H" and (
                ...
                if (i == 164 and pos.board[151] == "N" and pos.board[135] == "p") or (
                    j == 170 and pos.board[159] == "N" and pos.board[143] == "p"
                ):  # 兵顶马
                    continue
